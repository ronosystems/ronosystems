...
class UserRoleUpdateView(APIView):
    ...
    def put(self, request, user_id):
        ...
        if role not in ['super_admin', 'company_admin', 'company_manager', 'company_cashier', 'company_agent', 'company_staff', 'stock_controller', 'mpesa_agent', 'guest']:
            return Response(
                {'error': 'Invalid role. Choose: super_admin, company_admin, company_manager, company_cashier, company_agent, company_staff, stock_controller,  mpesa_agent, guest'},
    ...
    def get(self, request):
        return Response({
            ...
            'permissions': {
                ...
                'is_stock_controller': request.user.role == 'stock_controller',
