...
urlpatterns = [
    ...
    path('finance/purchases/<int:pk>/edit/', finance_views.purchase_edit, name='finance-purchase-edit'),
    path('finance/purchases/<int:pk>/delete/', finance_views.purchase_delete, name='finance-purchase-delete'),
